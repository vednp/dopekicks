...
export default function Card(product: cardProductInterface) {
  ...
  return (
    <div className="relative flex flex-col mt-6 text-gray-700 bg-transparent shadow-md bg-clip-border rounded-xl w-72 hover:scale-105 ease-in-out duration-300">
